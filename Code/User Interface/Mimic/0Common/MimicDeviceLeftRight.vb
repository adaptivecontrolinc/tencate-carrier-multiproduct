...
Public MustInherit Class MimicDeviceLeftRight : Inherits Windows.Forms.Control

  <Browsable(False), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)> _
  Public Property ImageLeftOff As Drawing.Image
  <Browsable(False), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)> _
  Public Property ImageLeftOn As Drawing.Image
  <Browsable(False), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)> _
  Public Property ImageLeftPartial As Drawing.Image
  <Browsable(False), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)> _
  Public Property ImageLeftFault As Drawing.Image

  <Browsable(False), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)> _
  Public Property ImageRightOff As Drawing.Image
  <Browsable(False), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)> _
  Public Property ImageRightOn As Drawing.Image
  <Browsable(False), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)> _
  Public Property ImageRightPartial As Drawing.Image
  <Browsable(False), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)> _
  Public Property ImageRightFault As Drawing.Image
  ...
  Private ReadOnly Property GetImage() As Drawing.Image
    Get
      If Orientation = EOrientation.Left Then
        Return GetLeftImage
      Else
  ...
  Private ReadOnly Property GetLeftImage As Drawing.Image
    Get
      If Fault Then Return ImageLeftFault
      If DeviceOn Then Return ImageLeftOn
      Return ImageLeftOff
    End Get
  End Property

  Private ReadOnly Property GetRightImage As Drawing.Image
    Get
      If Fault Then Return ImageRightFault
      If DeviceOn Then Return ImageRightOn
      Return ImageRightOff
    End Get
  End Property
