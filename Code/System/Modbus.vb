' Modbus protocol
Namespace Ports
  Public Class Modbus : Inherits Base
...
#End If
  ...
  ''' <summary>Allows for the MBAP header, etc, when communicating using Modbus Tcp/Ip</summary>
  Public Class ModbusTcp : Inherits NetworkPort
    ...
    Sub New(computer As String, port As Integer)
      MyBase.New(computer, port)
    End Sub


    Overrides Function BeginWrite(buffer() As Byte, offset As Integer, count As Integer, callback As AsyncCallback, state As Object) As IAsyncResult
    ...
    Overrides Function BeginRead(buffer() As Byte, offset As Integer, count As Integer, _
                                 callback As AsyncCallback, state As Object) As IAsyncResult
    ...
    Overrides Function EndRead(asyncResult As IAsyncResult) As Integer
